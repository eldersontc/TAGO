...
namespace TAGO_VISANET.Persistencia
{
    public class DataAccess
    {
        ...
        private string ConnectionString = "Data Source=(local);Initial Catalog=DB_VISA;Persist Security Info=True;User ID=sa;Password=sql;Connect Timeout=300";
        #endregion
        ...
        public int ExecuteStoreProcedureInsertUpdateDelete(string StoreProcedure, params object[] Parameters)
        {
            ...
            //return StoreProcedureIUDString;
        }
